...
for name in ['core.js','app.js']:offline=offline.replace('<script src="'+name+'?v=20260917-finite3"></script>','<script>'+(root/'web'/name).read_text().replace('</script','<\\/script')+'</script>')
